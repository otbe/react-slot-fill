...
var Slot = (function (_super) {
    ...
    Slot.prototype.render = function () {
        ...
        this.state.components.forEach(function (component, index) {
            ...
            if (fillChildProps) {
                ...
                children.forEach(function (child, index2) {
                    ...
                    aggElements.push(cloneElement(child, __assign({ key: index.toString() + index2.toString() }, fillChildProps2_1)));
                });
            }
            else {
                children.forEach(function (child, index2) {
                    ...
                    aggElements.push(cloneElement(child, { key: index.toString() + index2.toString() }));
                });
            }
        });
        if (typeof this.props.children === 'function') {
            ...
            return createElement('div', {}, aggElements);
        }
    };
    Slot.contextTypes = {
        manager: managerShape
